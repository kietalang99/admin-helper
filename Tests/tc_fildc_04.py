...
class filterByDeviceCategory(unittest.TestCase):
    ...
    def test_filter_device_category_04(self):
        self.driver.find_element_by_xpath('//*[@id="sidebar"]/ul/li[2]/a').click()
        self.driver.find_element_by_xpath("//select[@id='device-category']/option[text()=' Tablet ']").click()
        time.sleep(2)
    ...
    def tearDownClass(cls):
        cls.driver.close()
        cls.driver.quit()
        print("Test filter by Tablet category was completed")
